...
`,p=n.c.h2`
  ...
  letter-spacing: ${e=>{let{spacing:t}=e;return t||"5"}}px;
  padding: ${e=>{let{padding:t}=e;return t}};
...
`;u.defaultProps={borderwidth:4,color:a.a.primaryColorDarkest};var f=r("q1tI"),p=r.n(f),m=r("9eSz"),h=r.n(m);const g=n.c.div`
  position: relative;
...
`,b=e=>{let{fluid:t,title:r,height:n,mobileHeight:a,overlayColor:i,children:o,className:s}=e;return p.a.createElement(g,{bc:i},p.a.createElement(y,{fluid:t,title:r,height:n,mobileHeight:a}),o)};b.defaultProps={height:null,mobileHeight:null,overlayColor:"transparent",children:null,className:null};r("e+rj");n.c.section`
  padding: 2rem 0;
  width: 100vw;
  margin: 0 auto;
`;var v=r("d0g2");const{TABLET:w}=o.a,E=n.c.button`
  display: block;
...
`;E.defaultProps={color:a.a.primaryColorDarken,size:"1rem",weight:500,height:"3.5rem",width:"50%"};var S=r("mOvR"),T=r("Efxr");const A=T.b.div({visible:{x:"0",opacity:1,delayChildren:300,staggerChildren:50,transition:{duration:1e3,easing:"ease-out"}},invisible:{x:"-50%",opacity:0,transition:{duration:300,easing:"ease-out"}}}),C=T.b.div({visible:{x:"0",opacity:1,delayChildren:300,staggerChildren:1e3,transition:{duration:1e3,easing:"ease-out"}},invisible:{x:"-100%",opacity:0,delay:500,transition:{duration:300,easing:"ease-out"}}}),x=T.b.div({visible:{x:"0",opacity:1,delayChildren:300,staggerChildren:1e3,transition:{duration:1e3,easing:"ease-out"}},invisible:{x:"100%",opacity:0,delay:500,transition:{duration:300,easing:"ease-out"}}})},mOvR:function(e,t,r){"use strict";r.d(t,"b",(function(){return i})),r.d(t,"a",(function(){return o}));var n=r("vOnD"),a=r("MnMr");const i=n.c.span`
  //:hover &::after {
